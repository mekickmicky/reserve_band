<?php 
    require 'import-link.php';
    require 'import-script.php';
?>
<script src="asset/js/card-multi.js"></script>

<div id="carousel-example-multi" class="carousel slide carousel-multi-item v-2" data-ride="carousel">

  <!--Controls-->
  <div class="controls-top">
    <a class="btn-floating" href="#carousel-example-multi" data-slide="prev"><</a>
    <a class="btn-floating" href="#carousel-example-multi" data-slide="next">></a>
  </div>
  <!--/.Controls-->
